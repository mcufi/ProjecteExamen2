...
<html lang="en">
    ...
    <body>
        <div class="bg-[#fff1ea] h-screen flex flex-col items-center justify-center">
            <div>
                <h1 class="text-[#4D4242] font-[1000] text-6xl text-center mb-5"> 419 </h1>
            </div>
            ...
            <div>
                <h2 class="text-[#4D4242] font-[1000] text-xl text-center mt-8"> No estàs autenticat correctament. </h2>
            </div>
